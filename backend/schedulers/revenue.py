...
KINETIQ_LST_SNAPSHOT = {
    ...
    "khype": {
        ...
        "q4_2025_explanation": {
            "visible_history_from": "2025-10-08",
            "incoming_khype_fee_transfer_events": 5_653,
            "incoming_khype": 29_755.48,
            "october_tvl_reference_peak_usd": 2_653_266_457.0,
            "interpretation": "Q4 revenue combined high TVL with substantial unstake and instant-unstake fee capture; it was not generated by staking performance fees alone.",
            "history_limit_note": "The explorer exposes the latest 10,000 token transfers, so 2025-10-01 through 2025-10-07 is not included in these on-chain lower bounds.",
        },
        "methodology_note": "Lifetime treasury includes revenue retained before the 70/30 policy began. kHYPE revenue includes performance-fee and unstake-fee capture. Gross staking rewards are TVL multiplied by gross APR; they are not TVL or protocol revenue.",
    },
    "kmhype": {
